...
export const FUTURE_TEMPLATE_PROOFS=[ORGANIZATION_TEMPLATE,BUSINESS_TRUST_TEMPLATE,FRANCHISE_TEMPLATE,EDUCATION_TEMPLATE,PROFESSIONAL_TEMPLATE,ASSOCIATION_TEMPLATE,RESIDENTIAL_TEMPLATE,SUPPLY_CHAIN_TEMPLATE,INVESTOR_TEMPLATE,CUSTOMER_INTELLIGENCE_TEMPLATE,CUSTOM_NETWORK_TEMPLATE] as const;
