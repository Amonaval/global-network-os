...
ok('direct parking allocation UI',ui.includes('Allocate parking')&&ui.includes('allocateHsParking'));
ok('resident invitation link UI',ui.includes('/society-invite/')&&ui.includes('Copy invitation link'));
ok('dedicated society invitation page',invite.includes('acceptHsInvitation')&&invite.includes('Join & claim resident profile'));
...
ok('generic import hidden for housing',app.includes('kind!=="housing-society"&&<><InstitutionalBootstrapPanel'));
