...
ok('CI includes the latest regression chain, typecheck and production build',/validate:m6[a-d]|validate:m5/.test(ci)&&ci.includes('check:types')&&ci.includes('npm run build'));
