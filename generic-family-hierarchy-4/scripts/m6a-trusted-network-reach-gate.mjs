...
ok('CI preserves the M6-A regression chain through the latest mission',/validate:m7b|validate:m6[a-e]/.test(ci)&&ci.includes('check:types')&&ci.includes('npm run build'));
