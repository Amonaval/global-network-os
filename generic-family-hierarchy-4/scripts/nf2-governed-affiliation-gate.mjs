...
must('components/MyNetworksHome.tsx',['dynamic(()=>import("./NetworkFederationAffiliationManager")','"network_affiliation"','const enabledTools=(value:WorkspaceSection)=>toolsForSection(value).filter(item=>enabled(item.key))']);
