...
const residentSurfaces=[residentBase[0],meSurface,residentBase.find(s=>s.viewId==="directory")!,noticeSurface,complaintSurface,maintenanceSurface,amenitySurface,governanceSurface,...residentBase.filter(s=>!["home","directory"].includes(s.viewId))];
export const HOUSING_SOCIETY_APP_COMPOSITION={
 ...
 mobileBottomViewIds:["home","me","directory","complaints"],mobileMoreActiveViewIds:["notices","maintenance","amenities","governance","community","connections","admin","guide"],
 guide:{...base.guide,playgroundViewIds:["home","me","directory","notices","complaints","maintenance","amenities","governance","community","explorer","connections"]},
 launch:{...base.launch,playgroundTitle:"Housing Society Playground",playgroundDescription:"A realistic residential community centered on flats/units, residents, households and society structure.",playgroundRecommendation:"Start at Home, explore Society Structure, then browse Residents and Community.",pilotTargetsTitle:"Housing Society daily-operations pilot",pilotTargetsDescription:"Onboard 20–50 real units, run daily operations, then represent one complete maintenance billing cycle with flat-level dues and receipts, then record one committee meeting and resolution lifecycle."},
 whatsNew:{...base.whatsNew,kicker:"New in Housing Society",fallbackTitle:"Housing Society governance & decisions",fallbackDescription:"Committee terms, meetings, minutes, action items and controlled member resolutions now preserve society governance history."}
