...
const residentSurfaces=base.primaryNavigation.filter(s=>s.viewId!=="intelligence"&&s.viewId!=="places"&&s.viewId!=="contribute").map(s=>{
...
export const HOUSING_SOCIETY_APP_COMPOSITION={
 ...
 mobileBottomViewIds:["home","explorer","directory","community"],mobileMoreActiveViewIds:["connections","admin","guide"],
 guide:{...base.guide,playgroundViewIds:["home","explorer","directory","community","connections"]},
