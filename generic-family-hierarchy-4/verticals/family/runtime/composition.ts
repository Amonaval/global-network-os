...
export const FAMILY_APP_COMPOSITION = {
  ...
  primaryNavigation: [
    {viewId:"home",featureKey:"core.home",iconToken:"home",label:label("Home","होम","होम"),minimumExperience:"simple"},
    ...
    {viewId:"community",featureKey:"remember.memories",iconToken:"memories",label:label("Memories","यादें","आठवणी"),minimumExperience:"simple"},
  ],
  mobileMoreNavigation: [
    ...
    {viewId:"directory",featureKey:"core.directory",iconToken:"directory",label:label("Find family","परिवार खोजें","कुटुंब शोधा"),minimumExperience:"connected"},
    {viewId:"timeline",featureKey:"remember.history",iconToken:"history",label:label("Family history","परिवार का इतिहास","कुटुंब इतिहास"),minimumExperience:"connected"},
    ...
    {viewId:"participation",featureKey:"contribute.help_family",iconToken:"contribute",label:label("Help family","परिवार की मदद","कुटुंबाला मदत"),minimumExperience:"connected"},
