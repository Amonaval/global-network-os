...
const messages: Record<LanguageCode, MessageCatalog> = { en, hi, mr };

type LanguageContextValue = { language: LanguageCode; setLanguage: (language: LanguageCode) => void; t: (key: MessageKey, vars?: Record<string, string | number>) => string };
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(() => ({ language, setLanguage, t: (key: MessageKey, vars?: Record<string, string | number>) => interpolate(messages[language][key], vars) }), [language]);
