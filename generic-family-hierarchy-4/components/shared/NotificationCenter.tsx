...
export default function NotificationCenter({disabled=false}:{disabled?:boolean}){
 ...
 const [open,setOpen]=useState(false),[items,setItems]=useState<Notification[]>([]),[unread,setUnread]=useState(0),[busy,setBusy]=useState(false),[error,setError]=useState("");
